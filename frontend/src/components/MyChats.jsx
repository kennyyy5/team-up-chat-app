...
const MyChats = ({fetchAgain}) => {
  ...
  return (
    <Box display={{base: selectedChat?"none":"flex", md:"flex"}} flexDir="column" alignItems="center" p={3} bg="white" w={{base:"100%", md:"31%"}} borderRadius="lg"  borderWidth="1px">
        <Box pb={3} px={3} fontSize={{base:"28px", md:"30px"}} fontFamily="Anek Devanagari" display="flex" w="100%" justifyContent={"space-between"} alignItems={'center'}>
            My Chats
            <GroupChatModal>
        ...
        <Box  p={3} display="flex" flexDir="column" w="100%" h="100%" bg="#F8F8F8" borderRadius="lg" overflowY="hidden">
            {chats ? (
